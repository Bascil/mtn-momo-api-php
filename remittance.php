...
define('USER_ID', ''); // Remittance User ID
define('API_KEY', ''); // Remittance API Key
define('REMITTANCE_SUBSCRIPTION_KEY', ''); // Remittance Subscription KeyKey
...
function get_accesstoken(){
    ...
    $ch = curl_init("https://sandbox.momodeveloper.mtn.com/remittance/token/");
    ...
    curl_setopt(
        ...
        array(
            ...
            'Ocp-Apim-Subscription-Key: '.REMITTANCE_SUBSCRIPTION_KEY
        )
    );
  ...
  function disburse(){
    ...
    $endpoint_url = 'https://sandbox.momodeveloper.mtn.com/remittance/v1_0/transfer';
    ...
    $data = array(
          ...
          "payerMessage"=> "International Funds Transfer",
